	...
	<section id="blog" class="container">
		<center>
            <div class="row">
                ...
                <form id="form1" name="form1" method="post" action="<?= $root ?>/Home/updata_blog">
                  <table width="320" border="1" align="center" cellpadding="5" cellspacing="0" bgcolor="#000000">
                    ...
                    <tr>
                      ...
                      <td valign="baseline"><input type="text" name="newMemberID" id="newMemberID" value="<?= $data['sUserName'] ?>" style= "color:#000000" readonly  /></td> <!-- readonly為能讀不能編輯 -->
                    </tr>
                    <tr>
