				...
				<div class="container">					
					<div class="navbar-header">
						...
						<div class="navbar-brand">
							<a href="index"><h1><span>Com</span>pany</h1></a>
						</div>
					</div>
					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="about" class="active">關於我們</a></li>
	...
	<div class="aboutus">
		<div class="container">
			...
			<div>
				...
				<p><img src="images/B01.gif"></img>通過ISO-9001國際品保認證。</p>
				<p><img src="images/B02.gif"></img>全國首創 <strong style="color:red">租車送保險</strong>：<br>
<pre>
   ...
   5. 強制第三人責任險。<br><center><strong style= "color:red">註：車輛修理或失竊期間，承租人需另負擔無法營業損失</strong></center></pre></p>
				<p><img src="images/B03.gif"></img><strong style="color:red">免押證件、免簽本票、免保證金。</strong></p>
				<p><img src="images/B04.gif"></img>對消費者保障超越政府定型化契約。</p>
				<p><img src="images/B05.gif"></img><strong style="color:blue">提供甲地租車、乙地還車之服務。</strong>（ 詳情請看租車注意事項 <a href="rentalCar_notice"><img src="images/moreNotice.gif"></a> ）</p>
				<p><img src="images/B06.gif"></img>24小時道路救援，提供「行遍天下」全省拖吊、救援服務。</p>
				<p><img src="images/B07.gif"></img>服務人員親切和藹可親，讓您有家人的感覺。</p>
				<p><img src="images/B08.gif"></img><strong style="color:blue">歡迎來電預約、網路預約、門市預約。</strong></p>
		...
		<div class="container">
			...
			<div class="text-center">
				<div class="col-md-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
					<img src="images/rentalCar/1.jpg" alt="" >
					<h4>Bob_Chen</h4>
					<p>
						姓名 : 陳慶峰 <br>
						電話 : 0983275426 <br>
				...
				<div class="col-md-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
					<img src="images/rentalCar/2.jpg" alt="" >
					<h4>新秀聯盟大團隊</h4>
					<p>大家加油</p>
				</div>
			</div>
